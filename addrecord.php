...
<table>
  ...
  <tr id="rowwss">
    ...
    <td style="width:50px;text-align:center;height:30px;font-size:12px">
      <input style="width:50px" class="grade" type="text" name="1st[]">
    </td>
    <td style="width:50px;text-align:center;height:30px;font-size:12px">
      <input style="width:50px" class="grade" type="text" name="2nd[]">
    </td>
    <td style="width:50px;text-align:center;height:30px;font-size:12px">
      <input style="width:50px" class="grade" type="text" name="3rd[]">
    </td>
    <td style="width:50px;text-align:center;height:30px;font-size:12px">
      <input style="width:50px" class="grade" type="text" name="4th[]">
    </td>
    <td style="width:60px;text-align:center;height:30px;font-size:12px">
      <input style="width:50px" id="fin" type="text" name="final[]" readonly="">
    </td>
    <td style="width:60px;text-align:center;height:30px;font-size:12px">
      <input style="width:50px" type="text" name="units[]">
    </td>
    <td style="width:60px;text-align:center;height:30px;font-size:12px">
      ...
      <tbody id="table-body">
        ...
        ?>
          <tr id="rowws" class="<?php echo $i ?>">
            ...
            <td style="width:50px;text-align:center;height:30px;font-size:12px">
              <input style="width:50px" class="grade<?php echo $i ?>" onkeyup="calculateSum2(<?php echo $i ?>)" onkeydown="calculateSum2(<?php echo $i ?>)" type="text" name="1st[]">
            </td>
            <td style="width:50px;text-align:center;height:30px;font-size:12px">
              <input style="width:50px" class="grade<?php echo $i ?>" onkeyup="calculateSum2(<?php echo $i ?>)" onkeydown="calculateSum2(<?php echo $i ?>)" type="text" name="2nd[]">
            </td>
            <td style="width:50px;text-align:center;height:30px;font-size:12px">
              <input style="width:50px" class="grade<?php echo $i ?>" onkeyup="calculateSum2(<?php echo $i ?>)" onkeydown="calculateSum2(<?php echo $i ?>)" type="text" name="3rd[]">
            </td>
            <td style="width:50px;text-align:center;height:30px;font-size:12px">
              <input style="width:50px" class="grade<?php echo $i ?>" onkeyup="calculateSum2(<?php echo $i ?>)" onkeydown="calculateSum2(<?php echo $i ?>)" type="text" name="4th[]">
            </td>
            <td style="width:60px;text-align:center;height:30px;font-size:12px">
              <input style="width:50px;text-align:center" id="fin<?php echo $i ?>" type="number" name="final[]" readonly="">
            </td>
            <td style="width:60px;text-align:center;height:30px;font-size:12px">
              <input style="width:50px" type="text" name="units[]">
            </td>
