<div class="container">
		...
		<table>
			<tr>
				...
				<td style="width:800px;font-size:12px;line-height:1mm;text-align:center">
					...
					<p><b>San Juan National High School</b></p>
					<p>San Juan Southern Leyte</p>
				</td>
				<td style="width:20%;">
	...
	<div class="row">
		<div class="col-md-12">
			<center>
				<p><b>
						<h4>SECONDARY STUDENT'S PERMANENT RECORDS</h4>
					</b></p>
			</center>
		</div>
	</div>
				...
				<tr>
					<td>
						...
						<table style="border-collapse:collapse">
							<tr>
								<td style="width:200px;border:1px solid black;font-size:12px;">
									<center><b>Subjects</b></center>
								</td>
								<td style="width:60px;border:1px solid black;font-size:12px;">
									<center><b>Final Rating</b></center>
								</td>
								<td style="width:60px;border:1px solid black;font-size:12px;">
									<center><b>Units Earned</b></center>
								</td>
								<td style="width:150px;border:1px solid black;font-size:12px;">
									<center><b>Action<br>Taken</b></center>
								</td>
							</tr>
							<?php
							$syi = $row1['SYI_ID'];
							...
							?>
									<tr>
										...
										<td style="width:83px;border:1px solid black;font-size:10px;height:15px">
											<center><?php echo $row2['PASSED_FAILED'] ?></center>
										</td>
									</tr>
								<?php
								}
