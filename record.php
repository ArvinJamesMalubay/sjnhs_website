...
<div class="col-md-7 text-right">
  ...
  while ($sy = mysqli_fetch_assoc($query)) { ?>
    <a class='btn btn-success' href="rms.php?page=addrecord&id=<?php echo $id ?>&sy=<?php echo $sy['school_year'] ?>&prog=<?php echo isset($_GET['prog']) ? $_GET['prog'] : ''; ?>"><i class="fa fa-plus"> Add Record</i></a>
  <?php
  } ?>
</div>
