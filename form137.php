...
<body style="background-color:white">
	...
	<center>
		<div id='print'>
			...
			<div class="row">
				<div class="col-md-12">
					<hr style="border-color:black;border:1px solid black">
					</hr>
				</div>
			...
			<table style="float:left;margin-left:5px;margin-bottom:20px;">
				<tr>
					<td>
						...
						<table style="border-collapse:collapse; margin-right:45px; ">
							<tr>
								<td style="width:100px;border:1px solid black;font-size:12px;">
									<center><b>Learning Areas</b></center>
								</td>
								<td style="width:60px;border:1px solid black;font-size:12px;">
									<center><b>1st</b></center>
								</td>
								<td style="width:60px;border:1px solid black;font-size:12px;">
									<center><b>2nd</b></center>
								</td>
								<td style="width:60px;border:1px solid black;font-size:12px;">
									<center><b>3rd</b></center>
								</td>
								<td style="width:60px;border:1px solid black;font-size:12px;">
									<center><b>4rth</b></center>
								</td>
								<td style="width:80px;border:1px solid black;font-size:12px;">
									<center><b>Final Rating</b></center>
								</td>
								<td style="width:80px;border:1px solid black;font-size:12px;">
							...
							?>
									<tr>
										...
										<td style="width:60px;border:1px solid black;font-size:10px;height:15px;text-align:center"><?php echo $row2['1ST_GRADING'] ?></td>
										<td style="width:60px;border:1px solid black;font-size:10px;height:15px;text-align:center"><?php echo $row2['2ND_GRADING'] ?></td>
										<td style="width:60px;border:1px solid black;font-size:10px;height:15px;text-align:center"><?php echo $row2['3RD_GRADING'] ?></td>
										<td style="width:60px;border:1px solid black;font-size:10px;height:15px;text-align:center"><?php echo $row2['4TH_GRADING'] ?></td>
										<td style="width:60px;border:1px solid black;font-size:10px;height:15px;text-align:center"><?php echo $row2['FINAL_GRADES'] ?></td>
										<td style="width:80px;border:1px solid black;font-size:10px;height:15px;text-align:center"><?php echo $row2['PASSED_FAILED'] ?>
							...
							for ($q = $num4; $q < 5; $q++) {
								...
								<tr>
									...
									<td style="width:60px;border:1px solid black;font-size:12px;height:15px"></td>
									<td style="width:60px;border:1px solid black;font-size:12px;height:15px"></td>
									<td style="width:80px;border:1px solid black;font-size:12px;height:15px"></td>
								</tr>
							...
							?>
							<tr>
								<td style="width:150px;font-size:12px;height:15px">School</td>
								<td style="width:83px;border-bottom:1px solid black;font-size:12px;height:15px">
									<center><?php echo $row1['SCHOOL'] ?></center>
								</td>

								<td style="width:120;font-size:12px;height:15px;text-align:right">No. of Years</td>
								<td style="width:60px;border-bottom:1px solid black;font-size:12px;height:15px">
									<center><?php echo $row1['TOTAL_NO_OF_YEAR'] ?></center>
								</td>
							</tr>
							<tr>
								<td style="width:150px;font-size:12px;height:15px">Days of Present:</td>
								<td style="width:60px;border-bottom:1px solid black;font-size:12px;height:15px">
									<center><?php echo $row1['TDAYS_PRESENT'] ?></center>
								</td>
								<td style="width:12	0;font-size:12px;height:15px;text-align:right">Days of School:</td>
								<td style="width:60px;border-bottom:1px solid black;font-size:12px;height:15px">
									<center><?php echo $row1['TDAYS_OF_CLASSES'] ?></center>
								</td>
						...
						<table style="border-collapse:collapse">
							<tr>
								...
								<td style="width:120px;border-bottom:1px solid black;font-size:12px;height:15px">
									<center><?php echo $row1['TO_BE_CLASSIFIED'] ?></center>
								</td>
						...
						<table style="border-collapse:collapse">
							...
							?>
								...
								<tr>
									...
									<td style="width:60px;border:1px solid black;font-size:12px;height:15px"></td>
									<td style="width:60px;border:1px solid black;font-size:12px;height:15px"></td>
									<td style="width:90px;border:1px solid black;font-size:12px;height:15px"></td>
							...
							<tr>
								...
								<td style="width:60;font-size:12px;height:15px;text-align:right">No. of Years</td>
		...
		<div class="col-md-12">
			...
			<table>
				<tr>
					<td>
						<center>
							<h3 class="foo"><b>CERTIFICATION</b></h3>
						</center>
